...
public final class FeatureExtractionFactory {
     ...
     */
    public static IFeatureExtraction create(final Integer poFeatureExtractionMethod, IPreprocessing poPreprocessing)
     ...
     * @see FeatureExtractionAggregator
     */
    public static IFeatureExtraction create(final int piFeatureExtractionMethod, IPreprocessing poPreprocessing)
            throws FeatureExtractionException {
        IFeatureExtraction oFeatureExtraction = null;

        switch (piFeatureExtractionMethod) {
            case MARF.UCUNG_FEATURE_EXTRACTION:
                oFeatureExtraction = new ucungFeatureExtraction(poPreprocessing);
                break;
            case MARF.LPC:
